...
public class DrawFour extends View{
	Paint p;
	RectF rectf;
	float[] points;
	float[] points1;
	public DrawFour(Context context) {
		super(context);p = new Paint();
		rectf = new RectF(700,100,800,150);
		points = new float[]{100,50,150,100,150,200,50,200,50,100};
		points1 = new float[]{300, 200, 600, 200,300,300,600,300, 400, 100, 400, 400,500, 100,
		500, 400};
	}
